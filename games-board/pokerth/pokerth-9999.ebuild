...
EAPI=5					      ##original ebuild is EAPI=6
inherit flag-o-matic eutils qmake-utils git-2  ##git-2 added
...
#to pull source from git rather than the tarball at sourceforge
EGIT_REPO_URI="git://github.com/pokerth/pokerth.git"
SRC_URI=""
...
src_configure() {
	eqmake5 -spec linux-g++ pokerth.pro
}
